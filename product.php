...
if($admin == FALSE){
    $sql = "SELECT count(PRODUCT_ID) as TOTAL FROM PRODUCT where  category like   '%" . $cat. "%' and company like '%" . $filter_c . "%'  and flag = 1  AND os like '%" . $filter . "%'";
}else {
    $user_id = $_SESSION['user_id'];
    $sql = "SELECT count(PRODUCT_ID) as TOTAL FROM PRODUCT where  category like   '%" . $cat. "%' and company like '%" . $filter_c . "%'  and user_id = '$user_id'  AND os like '%" . $filter . "%' ";
}
                ...
                <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <table class="table">
                            <tr>
                                <td>
                                    <a  <?php echo "href='product.php?cat=Mobiles'"; ?>>Mobiles</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a  <?php echo "href='product.php?cat=Accessories'"; ?>><span class="glyphicon glyphicon-headphones">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse3" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            </span>Cart <span class="label label-info"><?php echo $number; ?></span></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination ">
                            ...
                            for($i=1;$i<=$total_pages;$i++)
                            {
                                ...
                                <input type='button' value= "<?php echo $i; ?>" onclick='get_data("<?php echo $i; ?>","<?php echo $filter; ?>","<?php echo $filter_c; ?>","<?php echo $cat; ?>")'>
                                <?php
                            }
                            ?>
...
<script type="text/javascript">
    function get_data(no,fil,com,cat1)
    {
    ...
    window.onload = get_data(1,"<?php echo $filter; ?>","<?php echo $filter_c; ?>","<?php echo $cat; ?>");
</script>
